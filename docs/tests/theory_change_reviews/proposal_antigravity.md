...
|---|---|---|---|
| Codex |  |  |  |
| Kimi K2.5 | TC-ANTI-01: P1; TC-ANTI-02: P0; TC-ANTI-03: P0; TC-ANTI-04: P1; TC-ANTI-05: P0 | 00_Brain_Trust_Charter.md 天条一、5.6节、5.7节 | TC-ANTI-01: 免审清单有价值，但需严格定义"简单维护"边界，防止成为绕过门禁的后门；TC-ANTI-02: P0-执行期探针是runtime关键缺口，当前系统确实缺乏事中拦截机制，与我的TC-KIMI-02互补；TC-ANTI-03: P0-越权免责留痕是责任边界核心，天条一需明确人类强压时的责任转移机制；TC-ANTI-04: P1-冷却区有价值，但需防止"冷却"成为"遗忘"的借口；TC-ANTI-05: P0-基础设施熔断与我的TC-KIMI-01/02直接相关，物理层限流确实会导致上层假死，必须有动态路由 |
| Qwen-3.5-Plus |  |  |  |
| Auto (Cursor) | TC-ANTI-01: P1; TC-ANTI-02: P0; TC-ANTI-03: P0; TC-ANTI-04: P1; TC-ANTI-05: P0 | 00_Brain_Trust_Charter.md 天条一、3.3 零假完成、5.4 完成态语义、5.6/5.7 | TC-ANTI-01: P1—免审清单可减摩擦，但须严格界定“简单维护”边界，否则易成门禁后门；TC-ANTI-02: P0—执行期探针填补 runtime 事中拦截缺口，主宪章当前仅有事前认知与事后验收；TC-ANTI-03: P0—越权免责留痕与天条一直接相关，人类强压时系统须留痕而非默认为系统背锅；TC-ANTI-04: P1—冷却区可防规则过拟合，但需避免“冷却”沦为“遗忘”；TC-ANTI-05: P0—基础设施熔断与动态路由应对 429/断网，否则上层门禁再严也会假死。 |
| MiniMax-M2.5 |  |  |  |
