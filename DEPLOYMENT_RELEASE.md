# Brain Trust Deployment Release v1.6.9
...
```bash
./scripts/build_release_branch.sh --version v1.6.9
git switch release
...
- `bash -n scripts/audit_task_ledger_sla.sh`
...
- `bash -n scripts/tests/test_audit_task_ledger_sla.sh`
